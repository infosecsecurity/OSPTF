...
4) View the contents of sources.list file
					...
					if repo == "1":
						...
						cmd2 = os.system("echo '# Kali repositories | Added by Katoolin\ndeb http://http.kali.org Kali-rolling main contrib non-free' >> /etc/apt/sources.list")
					elif repo == "2":
...
0) All
			 ...
			 ''')
						print ("\033[1;32mSelect a category or press (0) to install all Kali tools .\n\033[1;m")
